...
allowed-tools: Bash(node:*), Bash(npm:*), Bash(brew:*), AskUserQuestion
---
...
- If Gemini is installed but not authenticated, preserve the guidance to set `GEMINI_API_KEY` or run `!gemini auth login`.
